...
val dependencies = Seq(
  ...
  // Ciris config
  "is.cir" %% "ciris" % "2.4.0" excludeAll(excludeCatsCore, excludeCatsEffect, excludeCatsEffectKernel),

  // Logs
  "org.typelevel" %% "log4cats-slf4j" % "2.5.0" excludeAll(excludeCatsCore, excludeCatsEffect, excludeSl4jApi),
...
lazy val root = (project in file(".")).enablePlugins(NativeImagePlugin).settings(
  ...
  Compile / mainClass := Some("com.testingzone.services.neo4j.Main"),
